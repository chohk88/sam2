...
class PromptEncoder(nn.Module):
    ...
    def _embed_points(
        ...
        # Make int mask for each label condition
        ...
        # Use broadcasting-compatible indexing (alternative to broadcasting index_put for torch-trt compatibility)
    ...
    def forward(
        ...
        # Use alternative approach to handle concat with potentially empty tensor for torch-trt compatibility
